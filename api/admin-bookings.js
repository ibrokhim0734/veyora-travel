...
module.exports=async(req,res)=>{
  ...
  try{
    const r=await fetch(U+'/functions/v1/admin-bookings',{method:req.method,headers:{'Content-Type':'application/json','apikey':KEY,'Authorization':auth},body:req.method==='PATCH'?JSON.stringify(req.body||{}):undefined});
